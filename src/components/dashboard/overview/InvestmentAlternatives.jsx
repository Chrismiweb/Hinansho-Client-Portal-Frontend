...
import { ArrowUpRight, X, Phone, Mail, Globe } from "lucide-react";
...
const CONTACT = {
  phone:     "+234 707 083 1250",
  email:     "hinansho.ng@gmail.com",
  website:   "https://hinansho.com",
  instagram: "https://www.instagram.com/hinansho__ng?igsh=MW1ycTB0M3JnZGR3Zw==",
  Tiktok:    "https://www.tiktok.com/@hinansho_ng?_r=1&_t=ZS-975eBVtCfUy",
  whatsapp:  "https://wa.me/message/SPYBSS5ACZOSO1",
};
      ...
      <div className="w-full max-w-sm rounded-[24px] overflow-hidden shadow-xl bg-white">
        ...
        <div className="px-5 py-5 -mt-4 bg-white rounded-t-[20px] relative">
          ...
          <div className="grid grid-cols-3 gap-2 mb-5">
            {[
              { label: "Instagram", href: CONTACT.instagram, bg: "bg-[#FBEAF0]", color: "text-[#993556]",
              ...
              { label: "TikTok", href: CONTACT.Tiktok, bg: "bg-[#F0F0F0]", color: "text-[#010101]",
              ...
              { label: "WhatsApp", href: CONTACT.whatsapp, bg: "bg-[#EAF3DE]", color: "text-[#3B6D11]",
      ...
      <div className="w-full bg-white rounded-[36px] border border-gray-200 px-6 py-8 shadow-sm sm:px-10">
        ...
        {!loading && !error && alternatives.length === 0 && (
          <div className="text-center py-10">
            <p className="text-gray-500 text-sm">🎉 You own all available properties! Check back later for new listings.</p>
          </div>
        )}
          ...
          <div className="space-y-10">
            {alternatives.map(item => (
              <div key={item.id}
                ...
                {/* ✅ Property image instead of demo placeholder */}
                <div className="relative h-[44px] w-[50px] overflow-hidden rounded-md flex-shrink-0">
                  <img src={getPropertyImage(item.title)} alt={item.title}
      ...
      {selected && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="relative w-full max-w-md rounded-3xl bg-white p-6 shadow-xl max-h-[90vh] overflow-y-auto">
            ...
            {/* ✅ Property image in modal too */}
            <div className="relative mb-5 h-44 w-full overflow-hidden rounded-2xl bg-gray-100">
              <img src={getPropertyImage(selected.title)} alt={selected.title}
                className="w-full h-full object-cover"
                onError={e => { e.target.src = PLACEHOLDER; }} />
            </div>
