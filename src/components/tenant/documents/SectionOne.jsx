...
export default function SectionOne() {
  return (
    <div className="space-y-6">
      <button className="flex items-center gap-2 bg-[#0F172B] text-white px-5 py-2.5 rounded-full text-[16px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Total Documents */}
        <div className="bg-[#0F172A] text-white rounded-[32px] p-6">
        ...
        {/* New This Month */}
        <div className="bg-white rounded-[32px] p-6 border border-[#F1F5F9]">
          ...
          <span className="inline-block mt-2 text-sm px-3 py-1 rounded-full bg-[#F0FDF4] text-[#00A63E] font-bold">
            All downloaded
          </span>
        </div>
        ...
        <div className="bg-white rounded-[32px] p-6 border border-[#F1F5F9]">
          ...
          <p className="text-sm text-[#90A1B9] mt-3">Just now</p>
        </div>
      </div>
    </div>
  );
