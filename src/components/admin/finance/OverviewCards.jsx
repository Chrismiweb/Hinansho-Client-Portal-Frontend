...
export default function OverviewCards() {
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {/* Total Income */}
      <div className="bg-white rounded-[16px] border-2 border-[#F1F5F9] p-6 flex flex-col gap-[38px]">
        ...
        <div className="bg-[#1E1E1E] rounded-[16px] border-2 border-[#F1F5F9] p-6 flex flex-col gap-[38px]">
